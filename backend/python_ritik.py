...
out = cv2.VideoWriter(
    r'C:\Users\Mudit\defcon\public\output.mp4', 0x00000021, 20.0, (640, 480))
...
while vidcap.isOpened():
    ...
    for contour in contours:
        ...
        for encodeFace, faceLoc in zip(encodesCurFrame, facesCurFrame):
            ...
            # print(faceDis, end="~")
            for i in range(0, len(faceDis)):
                totalFaceDis[i] += faceDis[i]
...
for i in totalFaceDis:
    finalFaceDis.append(1-(i/len(cnt)))
print(finalFaceDis, end="~")
matchIndex = np.argmin(totalFaceDis)
if matches[matchIndex]:
    name = classNames[matchIndex].upper()
    print(name, end="")
# print(finalFaceDis, end="~")
